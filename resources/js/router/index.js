...
const routes = [
    ...
    {
        path: '/neighborhoods/:neighborhoodId/properties/create',
        name: 'property-create',
        component: PropertyCreate,
        meta: { requiresAuth: true },
    },
    {
        path: '/neighborhoods/:neighborhoodId/properties/:id/edit',
        name: 'property-edit',
        component: PropertyEdit,
        meta: { requiresAuth: true },
    },
    {
        path: '/neighborhoods/:neighborhoodId/properties/:id',
