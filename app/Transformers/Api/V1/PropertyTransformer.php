...
class PropertyTransformer extends TransformerAbstract
{
    ...
    public function transform(Property $property): array
    {
        ...
        return [
            ...
            'geocoding_accuracy_score' => $property->geocoding_accuracy_score,
            'geocoding_match_type' => $property->geocoding_match_type,
            'geocoding_data_source' => $property->geocoding_data_source,
            'geocoding_matched_address' => $property->geocoding_matched_address,
